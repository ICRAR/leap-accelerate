    ...
    protected:
        ...
        void PhaseRotateTest(ComputeImplementation impl)
        {
            ...
            if(impl == ComputeImplementation::casa)
            {
                ...
                std::tie(pIntegrations, pCalibrations) = ToCalibrateResult(pair);
            }
            ...
            std::vector<std::queue<cpu::IntegrationResult>>& integrations = *pIntegrations;
            std::vector<std::queue<cpu::CalibrationResult>>& calibrations = *pCalibrations;
